...
public class inventory_DM implements TalendJob {
	...
	public void tDBRollback_4_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tPostjob_4_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tDBClose_8_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tPrejob_4_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tDBConnection_8_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tDBRollback_4_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tPostjob_4_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tDBClose_8_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tPrejob_4_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tDBConnection_8_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tDBInput_1 = "SELECT \"" + context.ecom_eval_dw_Schema
						+ "\".FactInventory.InventoryID,\n		\"" + context.ecom_eval_dw_Schema
						+ "\".FactInventory.StockReceived,\n		\"" + context.ecom_eval_dw_Schema
						+ "\".FactInventory.StockSold,\n		\"" + context.ecom_eval_dw_Schema
						+ "\".FactInventory.StockOnHand,\n		\"" + context.ecom_eval_dw_Schema
						+ "\".FactInventory.Date,\n		\"" + context.ecom_eval_dw_Schema
						+ "\".FactInventory.ProductID,\n		\"" + context.ecom_eval_dw_Schema
						+ "\".FactInventory.SupplierID" + "\nFROM	\"" + context.ecom_eval_dw_Schema
						+ "\".FactInventory";
						...
						try {
							...
							if (updateFlag_tDBOutput_1 == 0) {
								...
								if (row1.StockReceived == null) {
									...
									pstmtInsert_tDBOutput_1.setInt(2, row1.StockReceived);
								}

								if (row1.StockSold == null) {
									pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
								} else {
									pstmtInsert_tDBOutput_1.setInt(3, row1.StockSold);
								}

								if (row1.StockOnHand == null) {
									pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
								} else {
									pstmtInsert_tDBOutput_1.setInt(4, row1.StockOnHand);
								}

								if (row1.Date != null) {
									pstmtInsert_tDBOutput_1.setTimestamp(5,
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.sql.PreparedStatement pstmt_tDBOutput_2 = conn_tDBOutput_2
						.prepareStatement("SELECT COUNT(1) FROM [" + tableName_tDBOutput_2 + "] WHERE [date] = ?");
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tDBInput_3 = "SELECT \"" + context.ecom_eval_dw_Schema
						...
						try {
							...
							if (updateFlag_tDBOutput_3 == 0) {
								...
								if (row3.ProductName == null) {
									...
									pstmtInsert_tDBOutput_3.setString(2, row3.ProductName);
								}

								if (row3.ProductCategory == null) {
									pstmtInsert_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_3.setString(3, row3.ProductCategory);
								}

								if (row3.ProductSubCategory == null) {
									pstmtInsert_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_3.setString(4, row3.ProductSubCategory);
								}
	...
	public void tDBInput_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				boolean isShareIdentity_tDBOutput_4 = globalMap.get("shareIdentitySetting_tDBConnection_3") != null
						&& (Boolean) globalMap.get("shareIdentitySetting_tDBConnection_3") == true;
				...
				String dbquery_tDBInput_4 = "SELECT \"" + context.ecom_eval_dw_Schema
						+ "\".SupplierDim.SupplierID,\n		\"" + context.ecom_eval_dw_Schema
						+ "\".SupplierDim.SupplierName,\n		\"" + context.ecom_eval_dw_Schema
						+ "\".SupplierDim.SupplierLocation" + "\nFROM	\"" + context.ecom_eval_dw_Schema
						+ "\".SupplierDim";
				...
				try {
					...
					while (rs_tDBInput_4.next()) {
						...
						if (row4.SupplierName == null) {
							...
							pstmtUpdate_tDBOutput_4.setString(1, row4.SupplierName);
						}

						if (row4.SupplierLocation == null) {
							pstmtUpdate_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
						} else {
							pstmtUpdate_tDBOutput_4.setString(2, row4.SupplierLocation);
						}
						...
						try {
							...
							if (updateFlag_tDBOutput_4 == 0) {
								...
								if (row4.SupplierName == null) {
									...
									pstmtInsert_tDBOutput_4.setString(2, row4.SupplierName);
								}

								if (row4.SupplierLocation == null) {
									pstmtInsert_tDBOutput_4.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_4.setString(3, row4.SupplierLocation);
								}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_3 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:PVx76Z3clnNM3SlHtDR8NuSlFzwO2m9A9Y7phg==");
	...
	public void tDBConnection_8Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				conn_tDBConnection_8 = java.sql.DriverManager.getConnection(url_tDBConnection_8, dbUser_tDBConnection_8,
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = inventory_DM.class.getClassLoader()
					.getResourceAsStream("ecomevaluation/inventory_dm_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = inventory_DM.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : inventory_DM");
		}
...
/************************************************************************************************
 * 187162 characters generated by Talend Open Studio for Data Integration on the
 * October 8, 2023 at 2:27:42 PM WEST
 ************************************************************************************************/