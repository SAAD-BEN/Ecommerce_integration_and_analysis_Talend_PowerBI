...
public class sales_DM implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (ecom_eval_sales_dm1_AdditionalParams != null) {
				...
				this.setProperty("ecom_eval_sales_dm1_AdditionalParams",
						ecom_eval_sales_dm1_AdditionalParams.toString());
	...
	public void tCreateTable_7_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tCreateTable_7_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE [" + tableName_tDBOutput_1
							+ "]([SalesID] INT  not null ,[ProductPrice] INT ,[QuantitySold] INT ,[TotalAmount] REAL ,[DiscountAmount] REAL ,[NetAmount] REAL ,[Date] DATE  not null ,[ProductID] INT  not null ,[ShipperID] INT  not null ,[CustomerID] INT ,primary key([SalesID],[Date]))");
				}
				...
				String dbquery_tDBInput_1 = "SELECT \"" + context.ecom_eval_dw_Schema
						+ "\".FactSales.SalesID,\n		\"" + context.ecom_eval_dw_Schema
						+ "\".FactSales.ProductPrice,\n		\"" + context.ecom_eval_dw_Schema
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (row1.CustomerID == null) {
							...
							pstmtUpdate_tDBOutput_1.setInt(9, row1.CustomerID);
						}
						...
						try {
							...
							if (updateFlag_tDBOutput_1 == 0) {
								...
								if (row1.ProductPrice == null) {
									...
									pstmtInsert_tDBOutput_1.setInt(2, row1.ProductPrice);
								}

								if (row1.QuantitySold == null) {
									pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
								} else {
									pstmtInsert_tDBOutput_1.setInt(3, row1.QuantitySold);
								}

								if (row1.TotalAmount == null) {
									pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.FLOAT);
								} else {
									pstmtInsert_tDBOutput_1.setFloat(4, row1.TotalAmount);
								}

								if (row1.DiscountAmount == null) {
									pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.FLOAT);
								} else {
									pstmtInsert_tDBOutput_1.setFloat(5, row1.DiscountAmount);
								}

								if (row1.NetAmount == null) {
									pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.FLOAT);
								} else {
									pstmtInsert_tDBOutput_1.setFloat(6, row1.NetAmount);
								}

								if (row1.Date != null) {
									pstmtInsert_tDBOutput_1.setTimestamp(7,
											new java.sql.Timestamp(row1.Date.getTime()));
								} else {
								...
								if (row1.CustomerID == null) {
									...
									pstmtInsert_tDBOutput_1.setInt(10, row1.CustomerID);
								}
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class SCDSK_tDBSCD_1 {
					...
					public int hashCode() {
						if (hashCodeDirty) {
							int prime = 31;
							hashCode = prime * hashCode + ProductID;
							hashCodeDirty = false;
						}
						return hashCode;
					}
				...
				String search_tDBSCD_1 = "SELECT [ProductID], [ProductCategory], [ProductName], [ProductSubCategory] FROM ["
						+ tableName_tDBSCD_1 + "]";
				...
				String insertionSQL_tDBSCD_1 = "INSERT INTO [" + tableName_tDBSCD_1
						+ "]([ProductID], [ProductCategory], [ProductName], [ProductSubCategory]) VALUES(?, ?, ?, ?)";
				...
				String updateSQLForType1_tDBSCD_1 = "UPDATE [" + tableName_tDBSCD_1
						+ "] SET [ProductCategory] = ?, [ProductName] = ?, [ProductSubCategory] = ? WHERE [ProductID] = ?";
				...
				String dbquery_tDBInput_2 = "SELECT \"" + context.ecom_eval_dw_Schema
						+ "\".ProductDim.ProductID,\n		\"" + context.ecom_eval_dw_Schema
						+ "\".ProductDim.ProductName,\n		\"" + context.ecom_eval_dw_Schema
						+ "\".ProductDim.ProductCategory,\n		\"" + context.ecom_eval_dw_Schema
						+ "\".ProductDim.ProductSubCategory" + "\nFROM	\"" + context.ecom_eval_dw_Schema
						+ "\".ProductDim";
							...
							if (lookUpValue_tDBSCD_1 == null) {
								...
								if ((lookUpValue_tDBSCD_1.ProductCategory == null && row2.ProductCategory != null)
										|| (lookUpValue_tDBSCD_1.ProductCategory != null
												&& !lookUpValue_tDBSCD_1.ProductCategory.equals(row2.ProductCategory))
										|| (lookUpValue_tDBSCD_1.ProductName == null && row2.ProductName != null)
										|| (lookUpValue_tDBSCD_1.ProductName != null
												&& !lookUpValue_tDBSCD_1.ProductName.equals(row2.ProductName))
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.sql.PreparedStatement pstmt_tDBOutput_3 = conn_tDBOutput_3
						.prepareStatement("SELECT COUNT(1) FROM [" + tableName_tDBOutput_3 + "] WHERE [date] = ?");
	...
	public void tDBInput_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (!whetherExist_tDBOutput_4) {
					try (java.sql.Statement stmtCreate_tDBOutput_4 = conn_tDBOutput_4.createStatement()) {
						stmtCreate_tDBOutput_4.execute("CREATE TABLE [" + tableName_tDBOutput_4
								+ "]([CustomerID] INT  not null ,[HashedPI] VARCHAR(255)  ,[CustomerState] VARCHAR(50)  ,[CustomerSegment] VARCHAR(60)  ,primary key([CustomerID]))");
					}
				}
				String update_tDBOutput_4 = "UPDATE [" + tableName_tDBOutput_4
						+ "] SET [HashedPI] = ?,[CustomerState] = ?,[CustomerSegment] = ? WHERE [CustomerID] = ?";
				...
				String dbquery_tDBInput_4 = "SELECT \"" + context.ecom_eval_dw_Schema
						+ "\".CustomerDim.CustomerID,\n		\"" + context.ecom_eval_dw_Schema
						+ "\".CustomerDim.HashedPI,\n		\"" + context.ecom_eval_dw_Schema
						+ "\".CustomerDim.CustomerState,\n		\"" + context.ecom_eval_dw_Schema
						+ "\".CustomerDim.CustomerSegment" + "\nFROM	\"" + context.ecom_eval_dw_Schema
						+ "\".CustomerDim";
						...
						try {
							...
							if (updateFlag_tDBOutput_4 == 0) {
								...
								if (row4.HashedPI == null) {
									...
									pstmtInsert_tDBOutput_4.setString(2, row4.HashedPI);
								}

								if (row4.CustomerState == null) {
									pstmtInsert_tDBOutput_4.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_4.setString(3, row4.CustomerState);
								}

								if (row4.CustomerSegment == null) {
									pstmtInsert_tDBOutput_4.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_4.setString(4, row4.CustomerSegment);
								}
	...
	public void tDBInput_11Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tDBInput_11 = "SELECT \"" + context.ecom_eval_dw_Schema
						+ "\".ShipperDim.ShipperID,\n		\"" + context.ecom_eval_dw_Schema
						+ "\".ShipperDim.ShipperName,\n		\"" + context.ecom_eval_dw_Schema
						+ "\".ShipperDim.ShippingMethod" + "\nFROM	\"" + context.ecom_eval_dw_Schema + "\".ShipperDim";
				...
				try {
					...
					while (rs_tDBInput_11.next()) {
						...
						if (row5.ShipperName == null) {
							...
							pstmtUpdate_tDBOutput_5.setString(1, row5.ShipperName);
						}

						if (row5.ShippingMethod == null) {
							pstmtUpdate_tDBOutput_5.setNull(2, java.sql.Types.VARCHAR);
						} else {
							pstmtUpdate_tDBOutput_5.setString(2, row5.ShippingMethod);
						}
						...
						try {
							...
							if (updateFlag_tDBOutput_5 == 0) {
								...
								if (row5.ShipperName == null) {
									...
									pstmtInsert_tDBOutput_5.setString(2, row5.ShipperName);
								}

								if (row5.ShippingMethod == null) {
									pstmtInsert_tDBOutput_5.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_5.setString(3, row5.ShippingMethod);
								}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:7RJTOZAO3jqnh/1QTQns2nV6VrIljyITG7vjwA==");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					if (dbSchema_tCreateTable_7 != null && dbSchema_tCreateTable_7.trim().length() != 0) {
						tableName_tCreateTable_7 = dbSchema_tCreateTable_7 + "].[" + tableName_tCreateTable_7;
					}
					java.sql.Connection conn_tCreateTable_7 = (java.sql.Connection) globalMap
					...
					if (!whetherExist_tCreateTable_7) {
						...
						stmt_tCreateTable_7.execute("CREATE TABLE [" + tableName_tCreateTable_7
					...
					globalMap.put("tCreateTable_7_QUERY", "CREATE TABLE [" + tableName_tCreateTable_7
							+ "]([ProductID] INT  not null ,[ProductName] VARCHAR(50)  ,[ProductCategory] VARCHAR(50)  ,[ProductSubCategory] VARCHAR(50)  ,primary key([ProductID]))");
				} catch (java.lang.Exception e) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = sales_DM.class.getClassLoader()
					.getResourceAsStream("ecomevaluation/sales_dm_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = sales_DM.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					...
					if (context.getStringValue("ecom_eval_sales_dm_AdditionalParams") == null) {
						...
						context.ecom_eval_sales_dm_AdditionalParams = (String) context
								.getProperty("ecom_eval_sales_dm_AdditionalParams");
					}
					...
					if (context.getStringValue("ecom_eval_sales_dm_Database") == null) {
						...
						context.ecom_eval_sales_dm_Database = (String) context
								.getProperty("ecom_eval_sales_dm_Database");
					}
					...
					if (context.getStringValue("ecom_eval_sales_dm_Password") == null) {
						...
						String pwd_ecom_eval_sales_dm_Password_value = context
								.getProperty("ecom_eval_sales_dm_Password");
						context.ecom_eval_sales_dm_Password = null;
						if (pwd_ecom_eval_sales_dm_Password_value != null) {
							if (context_param.containsKey("ecom_eval_sales_dm_Password")) {// no need to decrypt if it
																							// come from program
								...
								try {
									context.ecom_eval_sales_dm_Password = routines.system.PasswordEncryptUtil
											.decryptPassword(pwd_ecom_eval_sales_dm_Password_value);
					...
					if (context.getStringValue("ecom_eval_sales_dm1_Database") == null) {
						...
						context.ecom_eval_sales_dm1_Database = (String) context
								.getProperty("ecom_eval_sales_dm1_Database");
					}
					...
					if (context.getStringValue("ecom_eval_sales_dm1_Password") == null) {
						...
						String pwd_ecom_eval_sales_dm1_Password_value = context
								.getProperty("ecom_eval_sales_dm1_Password");
						context.ecom_eval_sales_dm1_Password = null;
						if (pwd_ecom_eval_sales_dm1_Password_value != null) {
							if (context_param.containsKey("ecom_eval_sales_dm1_Password")) {// no need to decrypt if it
																							// come from program
																							// argument or parent job
																							// runtime
								...
								try {
									context.ecom_eval_sales_dm1_Password = routines.system.PasswordEncryptUtil
											.decryptPassword(pwd_ecom_eval_sales_dm1_Password_value);
					...
					if (context.getStringValue("ecom_eval_sales_dm1_AdditionalParams") == null) {
						...
						context.ecom_eval_sales_dm1_AdditionalParams = (String) context
								.getProperty("ecom_eval_sales_dm1_AdditionalParams");
					}
				}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("ecom_eval_sales_dm_AdditionalParams")) {
				context.ecom_eval_sales_dm_AdditionalParams = (String) parentContextMap
						.get("ecom_eval_sales_dm_AdditionalParams");
			}
			...
			if (parentContextMap.containsKey("ecom_eval_sales_dm_Password")) {
				context.ecom_eval_sales_dm_Password = (java.lang.String) parentContextMap
						.get("ecom_eval_sales_dm_Password");
			}
			...
			if (parentContextMap.containsKey("ecom_eval_sales_dm1_Password")) {
				context.ecom_eval_sales_dm1_Password = (java.lang.String) parentContextMap
						.get("ecom_eval_sales_dm1_Password");
			}
			if (parentContextMap.containsKey("ecom_eval_sales_dm1_AdditionalParams")) {
				context.ecom_eval_sales_dm1_AdditionalParams = (String) parentContextMap
						.get("ecom_eval_sales_dm1_AdditionalParams");
			}
		}
...
/************************************************************************************************
 * 234997 characters generated by Talend Open Studio for Data Integration on the
 * October 8, 2023 at 10:50:34 PM WEST
 ************************************************************************************************/